...
//		
		...
		System.out.println("Default selected = " +options.getFirstSelectedOption().getText());
		...
		System.out.println("default selected =" +yearsel.getFirstSelectedOption().getText());
		...
		System.out.println("selected year is = "+yearsel.getFirstSelectedOption().getText());
		...
		System.out.println("Default selected =" +monthsel.getFirstSelectedOption().getText());
		...
		System.out.println("Default selected = "+daysel.getFirstSelectedOption().getText());
